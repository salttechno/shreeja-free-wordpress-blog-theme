 ...
 * install-plugins.php
 *
 * For installing & activating plugins
 * ------------------------------------------------------------------------------------
 */
...
add_action( 'tgmpa_register', 'shreeja_register_required_plugins' );
function shreeja_register_required_plugins() {
    /*
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'Ultimate Social Media PLUS',
    ...
    $config = array(
		'id'           => 'shreeja',                 // Unique ID for hashing notices for multiple instances of TGMPA.
